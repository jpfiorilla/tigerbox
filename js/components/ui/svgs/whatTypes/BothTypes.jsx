...
const BothTypes = ({ fill }) => {
    if (!fill) fill = '#4a4a4a';
    return(<svg xmlns="http://www.w3.org/2000/svg" viewBox="-4727.288 -1995.451 113.8 96.467">
      {/*<defs>
        <style>
          .cls-1 {
            <!--fill: #4a5157;-->
